                    ...
                    <div className="container py-3">
                        <div className="row">
                            <div className="card-body">
                                <h4 className="text-muted font-weight-normal mb-3" style={{color: "#737373 !important"}}> Về CabinEat</h4>
                                <div className="markdown-custom" style={{color: "white"}}>
                                    ...
                                    <div className="col-5 col-md-3">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-auto">
                                                <a href="#" title="Facebook" className="mr-3">
