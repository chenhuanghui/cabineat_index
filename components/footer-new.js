                    ...
                    <div className="row align-items-center justify-content-center">
                        <div className="col-10 col-md-7">
                            <div className="grid grid-gap-16-16">
                                ...
                                <p className="text-center">Với <a href="http://cabineat.vn" name="cabineat, nhà hàng số">cabineat</a> việc làm chủ hoạt động kinh doanh delivery của nhà hàng trở nên đơn giản hơn bao giờ hết, nhờ vào ứng dụng công nghệ được nghiên cứu và thiết kế phù hợp với các nhà hàng của Việt Nam.</p>
