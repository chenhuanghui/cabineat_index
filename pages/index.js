                ...
                <div className="main-container pt-5" style={{backgroundColor: "white"}}>                    
                    ...
                    ?
                        <section className="bg-dark custom">
                            <div className="container-fluid py-6">                            
                                ...
                                <h1 className="mt-0 mb-0 text-center markdown-custom"> <ReactMarkdown source={hero.fields.title} /> </h1>
                                <p className="text-center mt-5 markdown-custom"><ReactMarkdown source={hero.fields.sub_title} /></p>
                                <div className="row align-items-center justify-content-center">
                                    <a className="btn btn-primary pl-5 pr-5 pt-3 pb-3 font-weight-bold" href={hero.fields.call2action_href} target="_blank">{hero.fields.call2action}</a>
                                </div>
                            </div>
                        </section> 
                    : null
                    ...
                    <section className="container my-2 my-md-5 custom">
                        <div className="row mt-0 mt-md-6">
                            ...
                            <div className="col-12 col-md-6 card-body">
                                <h2 className="header-title mb-3 markdown-custom"><ReactMarkdown source={message.fields.title} /></h2>
                    ...
                    ?
                        <section className="container custom pt-5 pb-6 pt-md-6">
                            <h2 className="text-center markdown-custom"><ReactMarkdown source={pricing.fields.headline} /></h2>
